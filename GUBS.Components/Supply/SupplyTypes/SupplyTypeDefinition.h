...
namespace GUBS_Supply
{
	...
	public:
		...
		SupplyTypeDefinition& operator=(const SupplyTypeDefinition&) = default;	// copy assignment
		SupplyTypeDefinition& operator=(SupplyTypeDefinition&&) = default;		// move assignment

		static const SupplyTypeDefinition EmptySupply;

		bool HasUnitsOf(MeasurementUnit unit) const { return _Unit == unit; }
		MeasurementUnit SupplyUnit() const { return _Unit; }
		...
		bool operator==(const SupplyTypeDefinition& rhs) const { return fullHash() == rhs.fullHash(); }
		bool operator!=(const SupplyTypeDefinition& rhs) const { return !(operator==(rhs)); }
